...
public class CreateJobAPIWithDBValidationTest2 {
	...
	public void setup() {
		...
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "35323435988569", "35323435988569", "35323435988569", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(), Model.NEXUS_2_BLUE.getCode());
